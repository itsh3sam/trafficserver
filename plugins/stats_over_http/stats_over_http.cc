...
struct stats_state {
  ...
  z_stream                        zstrm;
  std::unordered_set<std::string> prometheus_v2_emitted;
#if HAVE_BROTLI_ENCODE_H
  b_stream bstrm;
#endif
  stats_state()
...
static const char RESP_HEADER_PROMETHEUS_V2_GZIP[] =
  "HTTP/1.0 200 OK\r\nContent-Type: text/plain; charset=utf-8\r\nContent-Encoding: gzip\r\nCache-Control: no-cache\r\n\r\n";
static const char RESP_HEADER_PROMETHEUS_V2_DEFLATE[] =
  "HTTP/1.0 200 OK\r\nContent-Type: text/plain; charset=utf-8\r\nContent-Encoding: deflate\r\nCache-Control: no-cache\r\n\r\n";
static const char RESP_HEADER_PROMETHEUS_V2_BR[] =
  "HTTP/1.0 200 OK\r\nContent-Type: text/plain; charset=utf-8\r\nContent-Encoding: br\r\nCache-Control: no-cache\r\n\r\n";
  ...
  parse_metric_v2(std::string_view name)
{
  ...
  auto add_label = [&](std::string_view key, std::string_view val) {
    ...
    labels += std::string(key) + "=\"" + std::string(val) + "\"";
  };
